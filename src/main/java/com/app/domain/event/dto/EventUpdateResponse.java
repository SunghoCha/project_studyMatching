...
public class EventUpdateResponse {
    ...
    @Builder
    public EventUpdateResponse(Long eventId, String title, String description, LocalDateTime endEnrollmentDateTime,
    ...
    public static EventUpdateResponse of(Event event) {
