...
class EventControllerTest {
    ...
    @WithAccount
    @DisplayName("모집마감, 이벤트 시작, 종료 시간이 올바르지 않으면 예외 발생")
